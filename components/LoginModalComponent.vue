  ...
  <div>
      ...
      <div class="col-12">
        <form @submit.prevent="authLogin">
          ...
          <div class="form-group">
            ...
            <p>
              Si olvidó o no cuenta con su CLAVE DE ACCESO, ingrese su correo
              electrónico y presione SOLICITAR CÓDIGO
            </p>
            <input
              type="text"
              class="form-control"
          ...
          <div class="form-group">
            <button class="btn btn-sm" type="submit" :disabled="disabled">
              Entrar
            </button>
            <button
    ...
    <div class="row" v-if="optionForm == 2">
      <div class="col-12">
        <ul class="faq-list">
          <li>
            <strong>Si el correo con tu CLAVE DE ACCESO no ha llegado:</strong>
            Generalmente la CLAVE DE ACCESO es enviada dentro de los proximos 5
            minutos, sin embargo pueden existir demoras de mayor tiempo
          ...
          <li>
            Si tienes dudas o mayores problemas para ingresar, puedes
            escribirnos en el formulario y en seguida nos pondremos en contacto
            contigo.
          </li>
          <li>
            Linea de atención telefónica a problemas de acceso:
            <a href="tel:5534114697">55 3411 4697</a>
          </li>
        </ul>
      </div>
      <div class="col-12">
        <p>
          Ingresa tus datos a continuación y un asesor se pondrá en contacto
    ...
    <div class="row">
      <div class="col text-center" v-if="optionForm != 2">
        <label class="cursor-pointer" @click="optionForm = 2"
          >¿Problemas para accesar?</label
        >
      </div>
      <div class="col text-center" v-if="optionForm != 1">
        <label class="cursor-pointer" @click="optionForm = 1"
  ...
  methods: {
    ...
    async authSendCode() {
      ...
      try {
        ...
        await this.$swal(
          "¡Bien!",
          "Tu código de acceso se ha enviado correctamente al correo electrónico proporcionado.",
          "success"
        );
        this.disabled = false;
        return true;
