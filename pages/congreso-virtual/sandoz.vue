                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 pt-4 mt-3 mb-0">
                            <h2 class="mb-4 pl-4">Bienvenido a SANDOZ</h2>
                        ...
                        <div class="col-xl-8 pt-4 mt-3 mb-3 movil">
                             <img src="~/assets/images/Logo-Pfizer.png" width="300px" class="movil float-left ml-2 pl-4 pt-3">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-0 contacto">
                            <div class="col-xl-10 offset-xl-1 p-4">
                                <h2 class="text-center mb-4">Contacto con SANDOZ</h2>
            ...
            script: [
                {
                    ...
                    innerHTML: 'var $zoho=$zoho || {};$zoho.salesiq = $zoho.salesiq || {widgetcode:"cf08dd203a80d52fa06cea8d24dcd2ef4b27035819983a1a65183917baafbcb6", values:{},ready:function(){}};var d=document;s=d.createElement("script");s.type="text/javascript";s.id="zsiqscript";s.defer=true;s.src="https://salesiq.zoho.com/widget";t=d.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t);d.write("<div id=\'zsiqwidget\'></div>");',
